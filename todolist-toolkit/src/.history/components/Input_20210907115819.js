...
export default function Input(){
  ...
  function handleKeyUp(event){
    ...
    const action = sendAction(todoObj);// type + todoObj
    console.log('action:',action);
    store.dispatch(action.todoObj);
    setInput(store.getState());

    console.log("input:", store.getState());
    target.value = "";
  }
